...
```
http://qt.gtimg.cn/q=sh601169,sz600000,sh000001     # 多只用逗号拼接
```
...
https://push2.eastmoney.com/api/qt/stock/fflow/kline/get
  ?secid=0.600000&fields1=f1,f2,f3,f7
...
https://push2delay.eastmoney.com/api/qt/slist/get
  ...
  &secid=0.600000&ut=<UT>&pi=0&pz=60&po=1&np=1
```
- 返回该股所属的**全部**板块（行业 + 概念 + 地域），每项含 BK 代码。
- 实测：600000 → BK1650 通信技术 / BK0714 5G概念 / BK0554 物联网 / BK0800 人工智能 / BK0953 鸿蒙概念 / BK1104 信创 / BK1061 数字经济
...
| 2 | 新浪 `money.finance.sina.com.cn/quotes_service/api/json_v2.php/CN_MarketData.getKLineData?symbol=sz600000&scale=240&ma=no&datalen=80` | **末根是前一交易日**，判当日位置须把 live 价 append 进序列 |
...
```
https://web.ifzq.gtimg.cn/appstock/app/fqkline/get?param=sz600000,day,,,800,qfq
```
